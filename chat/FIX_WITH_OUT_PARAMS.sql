-- DIFFERENT APPROACH: Use OUT parameters instead of RETURNS TABLE
-- This completely eliminates the ambiguity issue
...
SELECT 'Function recreated with OUT parameters - ambiguity eliminated' as status;
