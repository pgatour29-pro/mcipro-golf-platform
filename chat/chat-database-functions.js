 ...
 * OPTIMIZED: Single query with batch processing instead of sequential loops
 */
export async function getTotalUnreadCount() {
  ...
  if (uniqueRooms.length === 0) return 0;
  ...
  try {
    ...
    // Log per-room breakdown (only non-zero)
    ...
    console.error('[Chat] Error calculating unread count:', error);
    return 0;
  }
}
 ...
 * OPTIMIZED: Cached with 2-second TTL to prevent excessive queries
 */
