#!/usr/bin/env python3
"""
Add Golfer Caddy Booking Module
Connects golfers to the Golf Course Admin caddy management system
"""

import re

def add_golfer_caddy_booking_module(file_path):
    """Add comprehensive caddy booking module for golfers"""

    with open(file_path, 'r', encoding='utf-8') as f:
        content = f.read()

    # Find where to insert the new module (after GolferEventsManager or before </script>)
...
'''
    ...
    # Insert the module before the GolferEventsManager
    updated_content = content[:insertion_point] + caddy_booking_module + '\n' + content[insertion_point:]

    with open(file_path, 'w', encoding='utf-8') as f:
        f.write(updated_content)

    print("✅ Golfer Caddy Booking Module added successfully!")
    return True

if __name__ == "__main__":
    file_path = "public/index.html"  # Deploy to public folder for Vercel
    add_golfer_caddy_booking_module(file_path)
