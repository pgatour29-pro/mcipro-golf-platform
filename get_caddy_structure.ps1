...
$url = "https://pyeeplwsnupmhgbguwqs.supabase.co/rest/v1/caddy_profiles?limit=1"
$caddy = Invoke-RestMethod -Uri $url -Headers $headers -Method Get

Write-Host "=== CADDY TABLE STRUCTURE ===" -ForegroundColor Yellow
$caddy[0] | ConvertTo-Json -Depth 3
