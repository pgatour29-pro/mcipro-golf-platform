...
(function () {
  ...
  "#golferDashboard.g3:not(.round-active){padding-left:232px;background:#F3F6F3}\n" +
  "#g3Rail{display:none}\n" +
  ...
  "#g3Rail .g3-me .g3-sb{font-size:11px;color:rgba(255,255,255,.6);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}\n" +
  "#g3Rail .g3-me .user-handicap{background:none !important;border:0 !important;padding:0 !important;color:#4ade80 !important;font-weight:700;font-size:11px}\n" +
  ...
  "#golferDashboard.g3.light-mode:not(.round-active) #g3Home{display:grid;grid-template-columns:minmax(0,1fr) 380px;grid-template-rows:auto minmax(0,1fr);gap:18px 20px;height:calc(100vh - 64px - 44px - 72px);min-height:540px}\n" +
  ...
  "#golferDashboard.g3.light-mode:not(.round-active) #g3Band{display:flex;grid-column:1 / -1;align-items:stretch;background:#fff;border:1px solid #DDE5DE;border-radius:14px;box-shadow:0 1px 2px rgba(11,59,42,.06),0 6px 18px rgba(11,59,42,.07);overflow:hidden;height:88px;font-family:'Instrument Sans',sans-serif}\n" +
  ...
  "#g3Band .g3-leave{flex:none;width:170px;background:#0B3B2A;color:#fff;padding:12px 18px;display:flex;flex-direction:column;justify-content:center}\n" +
  "#g3Band .g3-leave .k{font-size:12px;color:rgba(255,255,255,.75);font-weight:600}\n" +
  "#g3Band .g3-leave .t{font-family:'Fraunces',Georgia,serif;font-size:42px;font-weight:600;line-height:1;letter-spacing:-.02em}\n" +
  "#g3Band .g3-cell{padding:12px 18px;display:flex;flex-direction:column;justify-content:center;gap:2px;border-right:1px solid #DDE5DE;min-width:0;flex:none}\n" +
  ...
  "#g3Band .g3-cell .v{font-size:16px;font-weight:600;color:#17221C;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}\n" +
  "#g3Band .g3-cell .v.disp{font-family:'Fraunces',Georgia,serif;font-size:20px}\n" +
  ...
  "@media (max-width:1499px){#g3Band .g3-leave{width:150px}#g3Band .g3-leave .t{font-size:36px}#g3Band .g3-wx{display:none}#g3Band .g3-tee{width:130px}#g3Band .g3-cad{width:120px}#g3Band .g3-mates{flex:0 1 220px}#g3Band .g3-cell{padding:10px 14px}}\n" +
  ...
  "#golferDashboard.g3.light-mode:not(.round-active) #g3Left > #liteCubesGrid{grid-template-columns:repeat(4,1fr) !important;grid-template-rows:none !important;grid-auto-rows:150px;gap:16px !important;height:auto !important;min-height:0 !important;max-height:none !important;margin:0 !important;flex:none}\n" +
  "@media (max-height:820px){#golferDashboard.g3.light-mode:not(.round-active) #g3Left > #liteCubesGrid{grid-auto-rows:126px}}\n" +
  "#golferDashboard.g3.light-mode:not(.round-active) #g3Left #cubeScheduleBody .cubeCaddyLine img{width:54px !important;height:54px !important;border-radius:12px !important}\n" +
  "#golferDashboard.g3.light-mode:not(.round-active) #g3Left #cubeScheduleBody .cubeCaddyLine{font-size:13px !important;margin-top:4px !important}\n" +
  ...
  ".g3-hcpv{font-family:'JetBrains Mono',ui-monospace,Menlo,monospace;font-weight:700;font-size:13px;color:#15803d;background:#E7F7EC;border-radius:999px;padding:2px 9px}\n" +
  ...
  var G3 = {
    ...
    build: function () {
      ...
      if (ov && grid) {
        ...
        left.insertAdjacentHTML('beforeend', '<div class="g3-card fill" id="g3Week"><div class="g3-hd"><h3>' + esc(T('g3.thisweek', 'This week')) + '</h3><span class="g3-pill turf" id="g3WeekN" style="display:none"></span><span class="hint">' + esc(T('g3.tapday', 'Tap a row to open the event')) + '</span></div><div class="g3-list" id="g3WeekBody"><div class="g3-empty">…</div></div></div>');
        home.querySelector('#g3Right').innerHTML =
          '<div class="g3-card" id="g3Live"><div class="g3-hd"><h3>' + esc(T('g3.livenow', 'Live now')) + '</h3><span class="g3-pill" id="g3LivePill"></span></div><div class="g3-list" id="g3LiveBody"><div class="g3-empty">…</div></div></div>' +
          '<div class="g3-card" id="g3Hcp"><div class="g3-hd"><h3>' + esc(T('g3.handicap', 'Handicap')) + '</h3><span class="g3-hcpv user-handicap">--</span></div><div class="g3-bd" id="g3HcpBody"><div class="g3-empty">…</div></div></div>' +
          '<div class="g3-card fill" id="g3Msgs"><div class="g3-hd"><h3>' + esc(T('g3.messages', 'Messages')) + '</h3><span class="messagesBadge g3-pill signal" style="display:none">0</span></div><div class="g3-list" id="g3MsgsBody"><div class="g3-empty">…</div></div></div>';
      }
    ...
    loadWeek: async function (_retry) {
      ...
      try {
        ...
        var rows = list.slice(0, 12).map(function (ev) {
    ...
    loadLive: async function () {
      ...
      try {
        ...
        body.innerHTML = keys.slice(0, 4).map(function (k) {
        ...
        }).join('') + (n > 4 ? '<div class="g3-empty" style="padding:8px">+' + (n - 4) + '</div>' : '');
    ...
    loadHcp: async function () {
      ...
      try {
        var r = await db.from('rounds').select('total_gross, total_stableford, played_at, created_at').eq('golfer_id', me).order('created_at', { ascending: false }).limit(500);
    ...
    loadMsgs: async function () {
      ...
      try {
        ...
        var list = Object.values(conv).sort(function (a, b) { return new Date(b.last.created_at) - new Date(a.last.created_at); }).slice(0, 4);
        var prof = {};
