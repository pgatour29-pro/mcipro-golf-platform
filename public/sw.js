...
// DEPLOYMENT VERSION: 2025-11-14-PRODUCTION-SCHEMA-V20

const SW_VERSION = 'production-schema-v20'; // Using ACTUAL production columns: title, event_date, entry_fee, max_participants, description, format
