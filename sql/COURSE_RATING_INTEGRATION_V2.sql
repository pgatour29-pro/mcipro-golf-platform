-- ============================================================================
-- COURSE RATING & SLOPE INTEGRATION SYSTEM V2
-- ============================================================================
-- Created: 2025-12-11
-- Purpose: Add rating/slope data to EXISTING courses table
-- NOTE: Your courses table uses 'name' not 'course_name', and 'id' is TEXT not UUID
-- ============================================================================

BEGIN;

-- ============================================================================
-- 1. ADD COLUMNS TO EXISTING COURSES TABLE
-- ============================================================================
...
-- Set course_code = id for existing courses (if not already set)
...
DECLARE
  v_tee_data JSONB;
BEGIN
  -- Get matching tee configuration from courses table (id is TEXT)
...
-- ============================================================================
-- 7. GET COURSE INFO FUNCTION (compatible with existing schema)
-- ============================================================================
...
-- VERIFICATION
-- ============================================================================
SELECT 'COURSE_RATING_INTEGRATION_V2.sql deployed successfully' as status;

-- Show courses with their new columns
SELECT id, name, course_code, par, tees FROM courses LIMIT 5;
