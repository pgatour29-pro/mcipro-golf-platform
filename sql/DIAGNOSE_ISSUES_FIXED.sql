-- =====================================================
-- DIAGNOSTIC QUERIES FOR BOTH ISSUES - FIXED VERSION
-- =====================================================

-- First, check what columns actually exist in rounds table
...
SELECT '=== TOTAL ROUNDS COUNT ===' as info;
...
-- Check most recent rounds (all types)
SELECT '=== MOST RECENT 5 ROUNDS ===' as info;
...
SELECT '=== RECENT SOCIETY EVENTS ===' as info;
...
-- =====================================================
SELECT '=== AVAILABLE CADDIES ===' as info;
...
SELECT '=== CADDY PROFILES COUNT ===' as info;

SELECT
    COUNT(*) as total_caddy_profiles,
