-- =====================================================
-- FIX BURAPHA COURSES - ONLY EXISTING COURSE IDs
-- =====================================================
-- This fixes ONLY courses that exist in the courses table
-- burapha_east and burapha_west
-- =====================================================

-- =====================================================
-- BURAPHA EAST COURSE - WHITE TEES (Most common)
-- =====================================================

DELETE FROM course_holes WHERE course_id = 'burapha_east';

-- White Tees (Men's Regular) - Most commonly played
...
-- Championship Tees (Black/Gold) - Advanced players
INSERT INTO course_holes (course_id, hole_number, par, stroke_index, yardage, tee_marker) VALUES
...
-- =====================================================
-- BURAPHA WEST COURSE - WHITE AND BLACK TEES
-- =====================================================
...
-- Black Tees (Championship) - Advanced players
INSERT INTO course_holes (course_id, hole_number, par, stroke_index, tee_marker, yardage) VALUES
...
FROM course_holes
WHERE course_id IN ('burapha_east', 'burapha_west')
...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE 'BURAPHA COURSES FIXED!';
    RAISE NOTICE '========================================';
    RAISE NOTICE 'Burapha East: 36 holes (White + Championship)';
    RAISE NOTICE '  White: Par 72, 6,326 yards';
    RAISE NOTICE '  Championship: Par 72, 7,274 yards';
    RAISE NOTICE '';
    RAISE NOTICE 'Burapha West: 36 holes (White + Black)';
    RAISE NOTICE '  White: Par 72, 6,209 yards';
    RAISE NOTICE '  Black: Par 72, 7,333 yards';
    RAISE NOTICE '';
    RAISE NOTICE 'Total: 72 holes updated';
    RAISE NOTICE 'All PAR and STROKE INDEX correct';
    RAISE NOTICE '========================================';
END $$;
