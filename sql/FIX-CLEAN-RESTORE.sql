-- =====================================================
-- CLEAN AND RESTORE TRAVELLERS REST EVENTS PROPERLY
-- =====================================================

BEGIN;

-- 1. DELETE ALL November and December events (clean slate)
DELETE FROM society_events
WHERE event_date >= '2025-11-01'
AND event_date < '2026-01-01';

-- 2. Insert November events (25 events)
...
-- 3. Insert December events (26 events)
