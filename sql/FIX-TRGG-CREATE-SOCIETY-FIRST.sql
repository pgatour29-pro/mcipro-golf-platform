-- ============================================================================
-- FIX: Create TRGG society record first, then insert events
-- ============================================================================

BEGIN;

-- Step 1: Check if society exists, if not create it
INSERT INTO societies (id, organizer_id, name, created_at, updated_at)
VALUES (
...
-- Step 2: Delete any existing TRGG events
DELETE FROM society_events WHERE title LIKE 'TRGG%';

-- Step 3: Insert all 51 TRGG events with the correct society_id
