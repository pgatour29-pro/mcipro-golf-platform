-- ============================================================================
-- SIMPLE FIX: Insert TRGG events without society_id
-- Just use organizer_id and title matching
-- ============================================================================
...
-- Insert all 51 TRGG events
-- Using society_id = NULL and organizer_id = NULL
-- Frontend will match by title prefix "TRGG"
...
-- IMPORTANT: After running this, you need to update the frontend index.html
-- The dashboard query is using society_id UUID but should use title matching for TRGG
-- See the fix at index.html line 37010-37026
