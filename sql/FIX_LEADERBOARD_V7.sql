-- FIX LEADERBOARD V7 - Use in_progress status, exclude test users
-- Data shows: all scorecards are 'in_progress', completed_at is NULL
-- Exclude: Bubba Gump, Willy
...
-- ============================================
-- DAILY STANDINGS - Today's rounds
-- ============================================
...
BEGIN
  RETURN QUERY
  SELECT
    ROW_NUMBER() OVER (ORDER BY COALESCE(SUM(sc.total_net), 0) DESC)::INTEGER,
    sc.player_id,
...
-- ============================================
-- SEASON STANDINGS - From Nov 1, 2025 to present
-- ============================================
...
-- TEST
-- ============================================
SELECT 'V7: Removed status=completed filter, using started_at, excluding Bubba Gump & Willy' as status;
