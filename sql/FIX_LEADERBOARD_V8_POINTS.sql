-- FIX LEADERBOARD V8 - Points-based system
-- 1st = 25pts, 2nd = 15pts, 3rd = 10pts, 4th = 7pts, 5th = 5pts
-- Position determined by lowest net score per event
...
-- ============================================
-- DAILY STANDINGS - Points from today's events
-- ============================================
...
BEGIN
  ...
  WITH event_positions AS (
    SELECT
      ...
      sc.player_name,
      sc.total_net,
      ROW_NUMBER() OVER (PARTITION BY sc.event_id ORDER BY sc.total_net ASC) as position
    FROM scorecards sc
...
-- ============================================
-- WEEKLY STANDINGS - Points from this week
-- ============================================
...
-- ============================================
-- MONTHLY STANDINGS - Points from this month
-- ============================================
...
-- ============================================
-- SEASON STANDINGS - Points from Nov 1, 2025
-- ============================================
...
-- TEST
-- ============================================
SELECT 'V8: Points system - 1st=25, 2nd=15, 3rd=10, 4th=7, 5th=5' as status;
