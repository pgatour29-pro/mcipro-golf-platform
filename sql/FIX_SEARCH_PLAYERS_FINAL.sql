-- FIX SEARCH PLAYERS - Count rounds from Dec 1, 2025 only
-- Also fix handicap to pull from profile_data if handicap_index is null
...
-- Test
SELECT 'search_players_global fixed - rounds from Dec 1, handicap from profile_data' as status;
