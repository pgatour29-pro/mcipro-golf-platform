...
-- v1370: and never writes a caddy registered by the caddy (user_id) or a golf course (created_by)
...
BEGIN
  ...
  IF v_row.id IS NOT NULL THEN
    ...
    -- v1370: a caddy a golf course added (or has since edited) is the course's — a golfer's notebook never writes it
