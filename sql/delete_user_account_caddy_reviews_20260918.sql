-- 2026-09-18 (v1255): the post-round caddy review keys on golfer_id (LINE id, text). Generated from the LIVE
-- pg_get_functiondef of delete_user_account (never from a repo copy) with ONE line added to text_targets.
-- Run: npx supabase db query --linked -f sql/delete_user_account_caddy_reviews_20260918.sql
