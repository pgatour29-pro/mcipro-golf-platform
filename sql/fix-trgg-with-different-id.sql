...
-- Update any existing golf_events that use Pete's LINE ID as organizer_id to use TRGG's new ID
UPDATE golf_events
SET organizer_id = 'Utrgg1234567890abcdefghijklmnopqr'
WHERE organizer_id = 'U2b6d976f19bca4b2f4374ae0e10ed873'
  AND organizer_name = 'Travellers Rest Golf Group';
...
-- Check TRGG events are using new organizer_id
SELECT
  COUNT(*) as trgg_event_count,
  organizer_id,
  organizer_name
FROM golf_events
WHERE organizer_name = 'Travellers Rest Golf Group'
...
BEGIN
  ...
  RAISE NOTICE '  - TRGG events updated to use new organizer_id';
  RAISE NOTICE '';
  RAISE NOTICE '========================================================================';
  RAISE NOTICE '';
END $$;
