-- =====================================================================
-- Khao Kheow - SIMPLE COURSE SELECTION SYSTEM (FINAL)
-- =====================================================================
...
INSERT INTO courses (id, name, location, holes, par)
VALUES
    ('khao_kheow_a', 'Khao Kheow - Course A', 'Chonburi, Thailand', 9, 36),
    ('khao_kheow_b_with_a', 'Khao Kheow - Course B (with A)', 'Chonburi, Thailand', 9, 36),
    ('khao_kheow_b_with_c', 'Khao Kheow - Course B (with C)', 'Chonburi, Thailand', 9, 36),
    ('khao_kheow_c', 'Khao Kheow - Course C', 'Chonburi, Thailand', 9, 36)
