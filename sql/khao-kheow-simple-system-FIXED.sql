-- =====================================================================
-- Khao Kheow - SIMPLE COURSE SELECTION SYSTEM (FIXED)
-- =====================================================================
...
-- =====================================================================
-- STEP 1: Create course entries in courses table FIRST
-- =====================================================================

INSERT INTO courses (id, name, location, description, holes, par)
VALUES
    ('khao_kheow_a', 'Khao Kheow - Course A', 'Chonburi, Thailand', 'Course A - 9 holes', 9, 36),
    ('khao_kheow_b_with_a', 'Khao Kheow - Course B', 'Chonburi, Thailand', 'Course B paired with A - 9 holes', 9, 36),
    ('khao_kheow_b_with_c', 'Khao Kheow - Course B', 'Chonburi, Thailand', 'Course B paired with C - 9 holes', 9, 36),
    ('khao_kheow_c', 'Khao Kheow - Course C', 'Chonburi, Thailand', 'Course C - 9 holes', 9, 36)
