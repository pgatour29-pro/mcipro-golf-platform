-- =====================================================================
-- Khao Kheow - SIMPLE COURSE SELECTION SYSTEM (MINIMAL)
-- =====================================================================
...
VALUES
    ('khao_kheow_a', 'Khao Kheow - Course A', 'Chonburi, Thailand'),
    ('khao_kheow_b_with_a', 'Khao Kheow - Course B (with A)', 'Chonburi, Thailand'),
    ('khao_kheow_b_with_c', 'Khao Kheow - Course B (with C)', 'Chonburi, Thailand'),
    ('khao_kheow_c', 'Khao Kheow - Course C', 'Chonburi, Thailand')
