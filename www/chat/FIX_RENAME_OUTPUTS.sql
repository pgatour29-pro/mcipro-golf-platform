-- ULTIMATE FIX: Rename output parameters to avoid ALL conflicts
-- Use output_room_id and output_room_slug instead of room_id/room_slug
...
CREATE OR REPLACE FUNCTION public.ensure_direct_conversation(
  me uuid,
  partner uuid,
  OUT output_room_id uuid,
  OUT output_room_slug text
)
LANGUAGE plpgsql
SECURITY DEFINER
...
SELECT 'SUCCESS: Output parameters renamed to output_room_id and output_room_slug' as status;
